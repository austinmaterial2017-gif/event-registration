...
var PUBLIC_ROUTES = {
  ...
  'listBundleRecoveryPlans': function(payload) { return listBundleRecoveryPlans_(payload); },
  ...
  'recoverBundleTicket': function(payload) { return recoverBundleTicket_(payload); },
