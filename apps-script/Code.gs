  ...
  return runRegistrationService_(function() {
    return withScriptLock(function() {
      ...
      try {
        ...
        appendBundlePlanRegistrationView_(plans[0], { bundleRegistrationId: registrationId, ticketNumber: ticketNumber, createdAt: timestamp, answers: JSON.stringify(answers), status: 'active' }, rules);
      } catch (error) {
